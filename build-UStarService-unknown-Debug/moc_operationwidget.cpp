...
#include "../UStarService/operationwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OperationWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OperationWidget_t qt_meta_stringdata_OperationWidget = {
    {
...
QT_MOC_LITERAL(12, 207, 19) // "onOtherPointClicked"
    ...
    "onOperationClicked\0onLocalImportClicked\0"
...
static const uint qt_meta_data_OperationWidget[] = {
...
void OperationWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        OperationWidget *_t = static_cast<OperationWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject OperationWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_OperationWidget.data,
      qt_meta_data_OperationWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OperationWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OperationWidget.stringdata0))
        return static_cast<void*>(const_cast< OperationWidget*>(this));
